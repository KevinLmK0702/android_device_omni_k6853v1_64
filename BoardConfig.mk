...
# Copyright (C) 2025 TWRP Device Tree Generator
#
...
ifeq ($(TARGET_FORCE_PREBUILT_KERNEL),true)
    ifneq ($(wildcard $(DEVICE_PATH)/prebuilt/kernel),)
        TARGET_PREBUILT_KERNEL := $(DEVICE_PATH)/prebuilt/kernel
        BOARD_PREBUILT_DTBOIMAGE := $(DEVICE_PATH)/prebuilt/dtbo
        BOARD_INCLUDE_RECOVERY_DTBO := true
    else
        $(warning Prebuilt kernel not found, building from source)
        TARGET_FORCE_PREBUILT_KERNEL := false
    endif
endif
...
BOARD_BOOTIMAGE_PARTITION_SIZE := 115455296
BOARD_RECOVERYIMAGE_PARTITION_SIZE := 115455296
...
BOARD_ALPS_DYNAMIC_PARTITIONS_PARTITION_LIST := system vendor product odm
